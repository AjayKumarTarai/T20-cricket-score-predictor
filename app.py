...
pipe = pickle.load(open('C:/Users/hp/Desktop/T20 world cup cricket score predictor/pipe.pkl','rb'))


teams = ['India', 'Australia', 'Bangladesh', 'New Zealand', 'South Africa', 'England', 'West Indies',
 'Afghanistan',
 'Pakistan',
 'Sri Lanka']
...
if st.button('Predict Score'):
    ...
    if wickets < 10:
        ...
        st.header("Predicted Score - " + str(current_score))
